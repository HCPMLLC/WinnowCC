  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/employer/career-pages/new" className="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary/90">
      ...
      {pages.length === 0 ? (
        <div className="bg-white rounded-xl border p-12 text-center">
          ...
          <Link href="/employer/career-pages/new" className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-lg">
