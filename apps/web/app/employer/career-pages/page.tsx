  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/employer/career-pages/new" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
      ...
      {pages.length === 0 ? (
        <div className="bg-white rounded-xl border p-12 text-center">
          ...
          <Link href="/employer/career-pages/new" className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700">
            ...
            <div key={page.id} className="bg-white rounded-xl border p-6 hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <Link href={`/employer/career-pages/${page.id}/builder`} className="p-2 hover:bg-gray-100 rounded-lg"><Edit className="w-5 h-5 text-gray-500" /></Link>
                  <Link href={`/employer/career-pages/${page.id}`} className="p-2 hover:bg-gray-100 rounded-lg"><Settings className="w-5 h-5 text-gray-500" /></Link>
