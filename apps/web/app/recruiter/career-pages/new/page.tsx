...
export default function NewCareerPagePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res.ok) {
      ...
      router.push(`/recruiter/career-pages/${data.id}/builder`);
    } else {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <Link href="/recruiter/career-pages" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-6">
      ...
      <div className="bg-white rounded-xl border p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="flex">
              <span className="px-4 py-2 bg-gray-100 border border-r-0 rounded-l-lg text-gray-500 text-sm">winnowcc.ai/careers/</span>
