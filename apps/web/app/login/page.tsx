    ...
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-2">
        ...
        <div className="relative">
          {/* Gradient: solid white at bottom, fading to transparent at top */}
          <div
            className="absolute inset-0"
            style={{
              background: "linear-gradient(to top, rgba(255,255,255,1) 0%, rgba(255,255,255,1) 25%, rgba(255,255,255,0.7) 35%, rgba(255,255,255,0.3) 42%, rgba(255,255,255,0) 50%, rgba(255,255,255,0) 100%)",
            }}
          />
