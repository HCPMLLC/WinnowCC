...
def _parse_with_claude(text: str) -> dict[str, Any]:
    ...
    prompt = (
        ...
        "8. For job_id_external: use the position-specific "
        "requisition number, vacancy number, or job ID "
        "(e.g., 2025-7642), NOT contract/solicitation "
        "numbers (e.g., DIR-CPO-TMP-445)\n"
